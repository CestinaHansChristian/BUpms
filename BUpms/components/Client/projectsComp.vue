<template>
    <div v-for="(item, index) in project_info" :key="index" class=" project-quick-status flex place-content-around border-2 border-gray-500 rounded-md bg-slate-100 mx-1">
