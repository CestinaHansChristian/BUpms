<template>
  <div class="image-icon-container bg-gradient-to-tl from-sky-500 to to-orange-300 from-10% md:pt-1">
    <div class="bicol-unviversity-logo relative grid place-content-start p-1 md:h-28 lg:h-36">
      <div
        class="logo-wrapper bg-slate-200 grid place-content-center rounded-full w-24 h-24 md:w-28 md:h-28 lg:h-36 lg:w-36 md:absolute -right-16 xl:-right-24 z-10 xl:h-44 xl:w-44 xl:top-5">
