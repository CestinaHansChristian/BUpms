            ...
            <div
                ...
                <div class="meta-info-wrapper grid md:w-2/12 md:mx-2 text-sky-600 font-bold ">
                    ...
                    <div class="status-wrapper text-xs md:text-base md:grid">
                        ...
                        {{ project.expand.Status.stages === 'stage1' ? "Pending" : project.expand.Status.stages ===
                            'stage2' ? "In Progress " : project.expand.Status.stages === 'stage3' ? "In Progress" :
                            'Completed' }}
                    </div>
                </div>
            </div>
            <div
                ...
                <ClientOnly>
                    ...
                    <div
                        ...
                        <!-- officer 1 -->
                        <div v-if="$pb.authStore.model?.role === 'officer1'"
