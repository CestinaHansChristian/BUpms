        ...
        <div class="mx-3 lg:max-w-screen-xl lg:mx-5">
            <div class="wrapper h-screen xl:h-[720px]">
                <div class="heading-wrapper grid grid-cols-2 md:grid-cols-6">
                    ...
                    <div
                        class="heading-wrapper text-xl flex justify-end text-sky-500 font-bold tracking-wider uppercase py-3 md:text-3xl md:col-span-3">
                        Project List
                    </div>
                </div>
                            ...
                            <div v-if="project.User === $pb.authStore.model?.id">
                                ...
                                <div v-if="!project.isArchived"
                                    ...
                                    <div
                                        ...
                                        <button :class="{ 'hidden': project.isCompleted }"
                ...
                <div v-else
                    class="project-list-wrapper-loading grid place-content-center  h-screen items-center py-2 p-2 bg-slate-300 rounded-lg md:h-5/6">
                    <h1 class="">Loading...</h1>
                </div>
            </div>
        </div>
