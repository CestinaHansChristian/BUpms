    ...
    <div class="bg-slate-200">
        <div class="h-screen grid place-items-center md:-my-11 mx-2 ">
            <div class="first-row-col shadow-inner shadow-slate-400 rounded-xl space-y-3 p-5 md:mx-5 lg:mx-0">
                <header class="text-center pt-2 text-base md:py-5 uppercase md:text-2xl tracking-wider font-bold text-slate-700 mx-2">
                    Update Details
                </header>
                ...
                <div @submit.prevent="createUser" class="inputfield md:flex md:gap-x-10 md:mx-10">
                    <div @click="addProfile" class="img-profile-container grid place-content-center gap-y-4">
                        <div class="img-wrapper bg-slate-100 rounded-full shadow-md">
                            <div v-if="userRole == 'admin'" class=" bg-orange-300 p-5 rounded-3xl border-2 border-orange-500">
                            ...
                            <div v-if="userRole == 'student'" class=" bg-slate-200 p-5 rounded-3xl border-2 border-slate-500">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="gray" viewBox="0 0 24 24" stroke-width="1" stroke="gray" class="size-24 md:size-32">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 6a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0ZM4.501 20.118a7.5 7.5 0 0 1 14.998 0A17.933 17.933 0 0 1 12 21.75c-2.676 0-5.216-.584-7.499-1.632Z" />
                                </svg>
                            </div> 
                            <div v-if="userRole == 'officer1' || userRole == 'officer2' || userRole == 'officer3'" class="border-2 border-sky-500 bg-sky-300 p-5 rounded-3xl">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="gray" viewBox="0 0 24 24" stroke-width="1" stroke="gray" class="size-24 md:size-32">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 6a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0ZM4.501 20.118a7.5 7.5 0 0 1 14.998 0A17.933 17.933 0 0 1 12 21.75c-2.676 0-5.216-.584-7.499-1.632Z" />
                                </svg>
                            </div>                           
                        </div>  
                        <span v-if="displayUser == ''" class="text-slate-700 text-center font-semibold tracking-wider opacity-0">
                            Username
                        </span>
                    ...
                    <form @submit.prevent="updateUserInfo" class="field-wrapper space-y-5 md:py-10 md:w-full md:space-y-5">
